...
- test de performence
- de tester la requête vers la BDD
...
vue que on a pas accer a la BDD, mais que la class Triangulation fait une demande pour avoir des donner alors on doit tester si les requete marche
